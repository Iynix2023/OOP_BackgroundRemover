...
// Export the ref type for use in the parent component
export interface PhotoSheetGeneratorRef {
  generateSheet: () => void;
}

const PhotoSheetGenerator = forwardRef<
  PhotoSheetGeneratorRef,
  PhotoSheetGeneratorProps
>(({ processedImage, onImageGenerated }, ref) => {
  ...
  // Expose the generateSheet method via ref
    ...
    <div className="border rounded-lg p-4">
      ...
      <div className="space-y-3 mb-4">
        ...
        <div>
          ...
          >
            <option value={ExportSize.STANDARD_35x45}>
              Singapore NRIC/Passport (35x45mm)
            </option>
            <option value={ExportSize.US_PASSPORT_2x2}>
              US Passport/Visa (2x2 inch)
            </option>
            <option value={ExportSize.CHINA_VISA}>China Visa (33x48mm)</option>
            <option value={ExportSize.MALAYSIA_PASSPORT}>
              Malaysia Visa/Passport (35x50mm)
            </option>
            <option value={ExportSize.AUSTRALIA_VISA}>
              Australia Visa (35x45mm)
            </option>
            <option value={ExportSize.INDIA_PASSPORT}>
              Indian Passport/Visa (35x35mm)
            </option>
        ...
        <div>
          ...
          <div className="flex justify-between mt-2">
            <SheetLayoutPreview
              layout={ExportLayout.SINGLE}
              onClick={(layout) =>
                setExportOptions({ ...exportOptions, layout })
              }
      ...
      {sheetImage && (
        <div className="space-y-4">
          {/* <div className="bg-gray-100 rounded-lg p-2">
              <img src={sheetImage} alt="Photo Sheet" className="w-full h-auto" />
            </div> */}
